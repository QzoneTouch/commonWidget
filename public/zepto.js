...
define.pack("./core",[],function(require, exports, module){
	...
	var undefined, key, $, classList, emptyArray = [], slice = emptyArray.slice, filter = emptyArray.filter, document = window.document, elementDisplay = {}, classCache = {}, getComputedStyle = document.defaultView.getComputedStyle, cssNumber = {
		...
		'z-index': 1,
		'zoom': 1
	}, fragmentRE = /^\s*<(\w+|!)[^>]*>/, tagExpanderRE = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, rootNodeRE = /^(?:body|html)$/i, // special attributes that should be get/set via method calls
...
define.pack("./zepto",["./core","./ajax.z","./data.z","./detect","./event.z","./form","./fx","./polyfill","./touch"],function(require, exports, module){
	var $ = require('./core');
	require('./ajax.z');
	require('./data.z');
	require('./detect');
